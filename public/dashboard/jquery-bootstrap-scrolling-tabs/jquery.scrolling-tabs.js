...
;(function ($, window) {
  ...
  var tabElements = (function () {
    ...
    function getNewElNavTabs() {
      return $('<ul class="nav nav-tabs"  id="myTab"  role="tablist"></ul>');
    }
    ...
    function getNewElTabAnchor(tab, propNames) {
      ...
      return $('<a class="position-relative"  onclick="MenuOnclick(\''+tab[propNames.paneId]+'\');">'+tab[propNames.title]+'</a>\
     <a href="javascript:;" id="a'+tab[propNames.paneId]+'" style="position: absolute;z-index:1;float: right;top: 0px;right: 0;" onclick="removeTab(\''+tab[propNames.paneId]+'\');"><i class="fa-solid fa-rectangle-xmark" style="color: rgb(128, 128, 128);"></i></a>\
      ');
    /*
      return $('<a role="tab" data-bs-toggle="tab" data-bs-target="#'+tab[propNames.paneId]+'" onclick="MenuOnclick(\''+tab[propNames.paneId]+'\');"></a>')
    ...
    */
    ...
    function getNewElTabLi(tab, propNames, options) {
      var liContent = options.tabLiContent || '<li role="presentation" id="'+tab[propNames.paneId]+'" class="nav-link position-relative  text-center widthauto" ></li>',
          $li = $(liContent),

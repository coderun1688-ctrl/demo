    ...
    'connections' => [
        ...
        'mariadb' => [
            ...
            'read' => [
                ...
                'database' => env('Read_DB_DATABASE', 'laravel'),
                'username' => env('Read_DB_USERNAME', 'root'),
                'password' => env('Read_DB_PASSWORD', ''),
            ],
            'write' => [
                'host' => env('Write_DB_HOST', '127.0.0.1'),
                'port' => env('Write_DB_PORT', '3306'),
                'database' => env('Write_DB_DATABASE', 'laravel'),
                'username' => env('Write_DB_USERNAME', 'root'),
            ...
            'strict' => false,
            'engine' => null,
			'sslmode' => 'disabled',  //required 强制加密  preferred 有 SSL 就用 disabled 關掉
